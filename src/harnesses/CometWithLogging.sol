...
import {IPriceFeed} from "comet/IPriceFeed.sol";
...
contract Comet is CometMainInterface {
    ...
    function isBorrowCollateralized(
        ...
        console.log("**COMET PRINCIPAL LIQUIDITY");
        ...
        for (uint8 i = 0; i < numAssets; ) {
            if (isInAsset(assetsIn, i)) {
                ...
                console.log("**COMET ASSET AMOUNT");
                console.log(newAmount);
                console.log("**COMET ASSET LIQUIDITY");
                console.log(mulFactor(newAmount, asset.borrowCollateralFactor));
            }
            unchecked {
                i++;
            }
        }
        console.log("**COMET TOTAL LIQUIDITY");
        console.logInt(liquidity);
