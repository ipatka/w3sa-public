...
import {Comet} from "../lib/comet/contracts/Comet.sol";
import {CometMath} from "../lib/comet/contracts/CometMath.sol";
import {CometStorage} from "../lib/comet/contracts/CometStorage.sol";
import {CometCore} from "../lib/comet/contracts/CometCore.sol";
...
contract CometUtils is CometMath {
    ...
    function getLiquidity(address account) public returns (int256) {
        ...
        console.log("PRINCIPAL LIQUDITY");
    ...
    function getWithdrawableCollateral(
        ...
        if (principal >= 0) withdrawable = uint256(balance);
            ...
            console.log("UNSIGNED PRINCIPAL");
            console.log(unsignedPrincipal);
            // uint256 minPrincipal = mulPrice(
            //     unsignedPrincipalValue,
            //     comet.getPrice(baseTokenPriceFeed),
            //     uint64(baseScale)
            // );
            // console.log("MIN PRINCIPAL");
            // console.log(minPrincipal);
            ...
            console.log("ASSET PRICE DISCOUNTED");
            console.log(assetPriceDiscounted);
            console.log("BASE PRICE");
            console.log(basePrice);
            console.log("MIN COLL BASE");
            ...
            // Minimum collateral is value of principal / asset price accounting for liquidation factor
            // uint256 minCollateral = (unsignedPrincipalValue * assetInfo.scale) /
            //     assetPrice;
            // uint minCollateral = comet.quoteCollateral(
            //     assetInfo.asset,
            //     minPrincipal
            // );
            // console.log("MIN COLLATERAL VALUE");
            // console.log(minCollateralValue);

            // uint256 minCollateral = divPrice(
            //     minCollateralValue,
            //     comet.getPrice(baseTokenPriceFeed),
            //     uint64(baseScale)
            // );
